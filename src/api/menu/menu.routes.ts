...
import { checkMenuOwnership } from '../../middleware/checkOwnership';
const router = express.Router();
const controller = new UserMenuController();

// GET /menus - Lấy danh sách tất cả các thực đơn của người dùng
...
// POST / menus - Tạo một bữa ăn mới cho người dùng
